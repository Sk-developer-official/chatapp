...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
   ...
   <!--  <i class="d-inline-block  fa fa-building fa-fw"></i> --><?php echo 'Sk Bank'; ?>
  </a>
        ...
        $array3 = $con->query("select * from userAccounts where accountNo = '$_POST[otherNo]'");
        {
          ...
          { $row2 = $array2->fetch_assoc();
            echo "<div class='row'>
                  ...
                  <div class='col' id='bal'>
                    
                    <h3>Withdraw Process.</h3><hr>
                   ...
                   <div id='btn'><button type='submit' name='withdrawOther' class='btn btn-success btn-bloc btn-sm my-1'> Withdraw</button></div></form>
                  </div>
                </div>";
           ...
           $row2 = $array3->fetch_assoc();
            ...
            <div class='row'>
                  <div class='col'>
                    ...
                    Account Holder Bank Name.
                    <input type='text' class='form-control' value='".'Sk Bank'."' readonly required>Bank Balance
                    <input type='text' class='form-control my-1'  value='Rs.$row2[balance]' readonly required>
                  ...
                  <div class='col'>
                   ...
                   <button type='submit' name='withdraw' class='btn btn-primary btn-bloc btn-sm my-1'> Withdraw</button></form><hr>
