...
<h1 class="alert alert-success rounded-0"><?php echo 'Sk Bank'; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Sk Developer</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
